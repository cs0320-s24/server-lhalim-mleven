...
public class EarningsDisparity {
    ...
    public EarningsDisparity (String state, String dataType, String avgEarnings, String numWorkers,
                              String earningDisparty, String employedPercent){
        this.state = state;
    ...
    public List<String> getED(){
        return List.of(this.state, this.dataType, this.avgEarnings, this.numWorkers,
                this.earningDisparty, this.employedPercent);
    }
}
